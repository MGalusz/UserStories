...
use UseStoriesBundle\Entity\Phone;
...
class PhoneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $phones = $em->getRepository('UseStoriesBundle:Phone')->findAll();
    ...
    {
        $phone = new Phone();
        $form = $this->createForm('UseStoriesBundle\Form\PhoneType', $phone);
    ...
    {
        $deleteForm = $this->createDeleteForm($phone);
        $editForm = $this->createForm('UseStoriesBundle\Form\PhoneType', $phone);

...
use UseStoriesBundle\Entity\Email;
...
class EmailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $emails = $em->getRepository('UseStoriesBundle:Email')->findAll();
    ...
    {
        $email = new Email();
        $form = $this->createForm('UseStoriesBundle\Form\EmailType', $email);
    ...
    {
        $deleteForm = $this->createDeleteForm($email);
        $editForm = $this->createForm('UseStoriesBundle\Form\EmailType', $email);

...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $addresses = $em->getRepository('UseStoriesBundle:Address')->findAll();
    ...
    {
        $address = new Address();
        $form = $this->createForm('UseStoriesBundle\Form\AddressType', $address);
    ...
    {
        $deleteForm = $this->createDeleteForm($address);
        $editForm = $this->createForm('UseStoriesBundle\Form\AddressType', $address);
